...
const AboutUsSection = () => {
    return (
        <section className="h-screen flex items-center justify-center bg-[url('../src/assets/bgSalidaNacional.jpg')] bg-center bg-cover">
            {/* Cover de imágen */}
            {/* <div className="absolute inset-0 bg-[url(../src/assets/meteorShower.jpg)] bg-center [mask-image:linear-gradient(180deg,white,rgba(255,255,255,0))] "></div> */}
            <div className='w-4/5 sm:w-1/2 m-auto drop-shadow-[-3px_3px_6px_rgba(0,0,0,1)]'>
                {/* Logos */}
                ...
                <div className='text-gray-600 py-4 text-center'>
                    <h1 className='text-5xl text-white font-normal italic'>NOSOTROS</h1>
                    <p className='text-2xl sm:text-3xl font-extralight text-gray-300'>SECCIÓN EN CONSTRUCCIÓN</p>
                </div>
