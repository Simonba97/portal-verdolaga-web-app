...
const MatchDetail = () => {
    ...
    useEffect(() => {
        const callAsync = async () => {
            try {
                ...
                if (dataResponse && dataResponse.fixture.status.short == TypesStatusFixturesShort.MatchFinished) {
    ...
    return (
        <div id='matchDetailContainer'>
            ...
            {matchData && matchData.fixture.status.short === TypesStatusFixturesShort.MatchFinished &&
                <section className="flex justify-center">
                    <Tabs
                        tabs={[
                            {
